...
export async function apiAdminGetSpots() {
  const res = await fetch(`${BASE_URL}/admin/spots`, {
    headers: authHeaders(),
  });
  return res.json();
}
...
export async function apiMyRegistrations() {
  const res = await fetch(`${BASE_URL}/my-registrations`, {
    headers: authHeaders(),
  });
  return res.json();
}
...
export async function apiConfirmRegistration(registrationId) {
  const res = await fetch(
    `${BASE_URL}/registrations/${registrationId}/confirm`,
    {
      method: "PUT",
      headers: authHeaders(),
    },
...
export async function apiGetGuides() {
  try {
    ...
    return { success: false, message: "Gagal memuat daftar panduan." };
  }
}

export async function apiGetGuideDetail(id) {
  try {
    const res = await fetch(`${BASE_URL}/guides/${id}`);
    return await res.json();
  } catch (error) {
    console.error(`Error fetching guide detail ID ${id}:`, error);
    return { success: false, message: "Detail panduan tidak ditemukan." };
  }
}

export async function apiCreateGuide(formData) {
  try {
    const res = await fetch(`${BASE_URL}/guides`, {
      method: "POST",
      headers: authHeaders(),
    ...
    return { success: false, message: "Gagal membuat panduan baru." };
  }
}

export async function apiUpdateGuide(id, formData) {
  try {
    ...
    console.error(`Error updating guide ID ${id}:`, error);
    return { success: false, message: "Gagal memperbarui panduan." };
  }
}
...
export async function apiDeleteGuide(id) {
  try {
    ...
    console.error(`Error deleting guide ID ${id}:`, error);
    return { success: false, message: "Gagal menghapus panduan." };
  }
}
